                    ...
                    <c:choose>
                        <c:when test="${not empty sessionScope.clientUser}">
                            <div style="display: inline-flex; align-items: center; gap: 10px;">
                                <a href="#" class="icon-link" title="${sessionScope.clientUser.email}">
                                    <i class="fas fa-user-check" style="color: green;"></i>
                                    <span style="font-size: 14px; margin-left: 5px;">${sessionScope.clientUser.fullName}</span>
                                </a>
                                <a href="/logout" style="text-decoration: none; border: 1px solid #ff4757; color: #ff4757; padding: 4px 8px; border-radius: 4px; font-size: 13px;">Đăng xuất</a>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <a href="/login" class="icon-link" title="Đăng nhập"><i class="fas fa-user"></i></a>
                        </c:otherwise>
                    </c:choose>
